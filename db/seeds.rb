...
@review_4 = @tire.reviews.create(title: 'Review Title 1', content: "Content 1", rating: 1)
@review_5 = @tire.reviews.create(title: 'Review Title 2', content: "Content 2", rating: 2)
@review_6 = @tire.reviews.create(title: 'Review Title 3', content: "Content 3", rating: 3)
...
@review_10 = @bike.reviews.create(title: 'Review Title 1', content: "Content 1", rating: 1)
@review_11 = @bike.reviews.create(title: 'Review Title 2', content: "Content 2", rating: 4)
@review_12 = @bike.reviews.create(title: 'Review Title 3', content: "Content 3", rating: 5)

#pull_toy_reviews
@review_13 = @pull_toy.reviews.create(title: 'Review Title 1', content: "Content 1", rating: 1)
...
@review_16 = @pull_toy.reviews.create(title: 'Review Title 1', content: "Content 1", rating: 4)
@review_17 = @pull_toy.reviews.create(title: 'Review Title 2', content: "Content 2", rating: 5)
@review_18 = @pull_toy.reviews.create(title: 'Review Title 3', content: "Content 3", rating: 5)
...
@review_22 = @brush.reviews.create(title: 'Review Title 1', content: "Content 1", rating: 3)
@review_23 = @brush.reviews.create(title: 'Review Title 2', content: "Content 2", rating: 2)
@review_24 = @brush.reviews.create(title: 'Review Title 3', content: "Content 3", rating: 1)
