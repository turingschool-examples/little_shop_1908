...
RSpec.describe "When I am creating a new item" do
  before(:each) do
    @brian = Merchant.create(name: "Brian's Dog Shop", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
  end

  it 'I see a link to add a new item for that merchant in the merchant items index page' do
  ...
  it 'I see alert flash messages when I submit form with blank fields' do
