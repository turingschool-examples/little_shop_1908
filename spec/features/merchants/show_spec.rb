...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      ...
      @light = @bike_shop.items.create(name: "Light", description: "Its a light!", price: 100, image: "https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 5)
      @horn = @bike_shop.items.create(name: "Horn", description: "Its a horn!", price: 40, image: "https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 5)
    end
    ...
    it 'Has merchant statistics' do
      ...
      within ".merchant-stats" do
        expect(page).to have_content("Count of items: 4")
    ...
    it 'Has top three reviewed merchant items' do
      review_1 = @tire.reviews.create(title: "It's Great!", content: "Best!", rating: 2)
      review_2 = @chain.reviews.create(title: "It's Great!", content: "Best!", rating: 1)
      review_3 = @light.reviews.create(title: "It's Great!", content: "Best!", rating: 3)
      review_4 = @horn.reviews.create(title: "It's Great!", content: "Best!", rating: 4)
